...
(function ($) {
  ...
  mm.add(
    ...
    (context) => {
      ...
      if (document.querySelector(".banner-three-area")) {
        ...
        gsap.set(".banner-three-portrait-reveal", {
          clipPath: "inset(100% 0 0 0)",
          webkitClipPath: "inset(100% 0 0 0)",
        });
        gsap.set(".banner-three-man", {
          yPercent: 18,
          scale: 0.86,
        ...
        const ab2 = gsap.timeline({
          duration: 5,
          scrollTrigger: {
            trigger: ".banner-three-area",
            scrub: 1.5,
            start: "top top",
            end: "bottom top",
          },
        });
        ab2.to(".banner-three-title", {
          scale: scaleVal,
          color: bigtextColor,
          duration: 2,
          y: yVal,
        ...
        ab2.to(".banner-three-portrait-reveal", {
          clipPath: "inset(0% 0 0 0)",
          webkitClipPath: "inset(0% 0 0 0)",
          duration: 2.4,
          ease: "power2.out",
        }, 0.05);
        ab2.to(".banner-three-man", {
          yPercent: 0,
          scale: 1.08,
          duration: 2.4,
          ease: "power2.out",
        }, 0.15);
        ab2.to(".banner-three-title-left", {
          xPercent: -16,
          duration: 2,
          ease: "power2.out",
        }, 0.55);
        ab2.to(".banner-three-title-right", {
          xPercent: 16,
          duration: 2,
          ease: "power2.out",
        }, 0.55);
